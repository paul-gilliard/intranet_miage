...
exports.gamesRouter.get("/", (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const games = (yield database_service_1.collections.listingsAndReviews.find({}).toArray());
...
exports.gamesRouter.get("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const game = (yield database_service_1.collections.listingsAndReviews.findOne(query));
        if (game) {
...
exports.gamesRouter.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield database_service_1.collections.listingsAndReviews.insertOne(newGame);
        result
...
exports.gamesRouter.put("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const query = { _id: new mongodb_1.ObjectId(id) };
        const result = yield database_service_1.collections.listingsAndReviews.updateOne(query, { $set: updatedGame });
        result
...
exports.gamesRouter.delete("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const query = { _id: new mongodb_1.ObjectId(id) };
        const result = yield database_service_1.collections.listingsAndReviews.deleteOne(query);
